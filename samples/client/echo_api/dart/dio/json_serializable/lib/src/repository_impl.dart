...
class JsonSerializableRepository extends SerializationRepositoryBase {
    ...
    T deserialize<T>(Object? value, TypeInfo targetTypeInfo, {Object? context}) {
        ...
        switch (targetRootType) {
            ...
            return AppleGrandparentDisc.fromJson(value as Map<String, dynamic>) as T;
            case AppleOneOfDisc:
            ...
            return BananaGrandparentDisc.fromJson(value as Map<String, dynamic>) as T;
            ...
            return ComposedDiscMissingFromProperties.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscOptionalTypeCorrect:
            return ComposedDiscOptionalTypeCorrect.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscOptionalTypeInconsistent:
            return ComposedDiscOptionalTypeInconsistent.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscOptionalTypeIncorrect:
            return ComposedDiscOptionalTypeIncorrect.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscRequiredInconsistent:
            return ComposedDiscRequiredInconsistent.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscTypeInconsistent:
            return ComposedDiscTypeInconsistent.fromJson(value as Map<String, dynamic>) as T;
            case ComposedDiscTypeIncorrect:
            return ComposedDiscTypeIncorrect.fromJson(value as Map<String, dynamic>) as T;
            case DeprecatedObject:
            return DeprecatedObject.fromJson(value as Map<String, dynamic>) as T;
            case DiscMissingFromProperties:
            return DiscMissingFromProperties.fromJson(value as Map<String, dynamic>) as T;
            case DiscOptionalTypeCorrect:
            return DiscOptionalTypeCorrect.fromJson(value as Map<String, dynamic>) as T;
            case DiscOptionalTypeIncorrect:
            return DiscOptionalTypeIncorrect.fromJson(value as Map<String, dynamic>) as T;
            ...
            return FooBasicGetDefaultResponse.fromJson(value as Map<String, dynamic>) as T;
            case FooRef:
            ...
            return FruitGrandparentDisc.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineDisc:
            return FruitInlineDisc.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineDiscOneOf:
            return FruitInlineDiscOneOf.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineDiscOneOf1:
            return FruitInlineDiscOneOf1.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineInlineDisc:
            return FruitInlineInlineDisc.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineInlineDiscOneOf:
            return FruitInlineInlineDiscOneOf.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineInlineDiscOneOf1:
            return FruitInlineInlineDiscOneOf1.fromJson(value as Map<String, dynamic>) as T;
            case FruitInlineInlineDiscOneOfOneOf:
            return FruitInlineInlineDiscOneOfOneOf.fromJson(value as Map<String, dynamic>) as T;
            case FruitOneOfDisc:
